...
- 看代码，也确实是 1:1 的模型
    ...
    - 不过这里也有不同
        ...
        - nodejs 为 worker 创建了 libuv loop，而 napa.js 没有
- 序列化反序列化，不像 napa.js 用 JSON.stringify，全部都是用 [v8 ValueSerializer](https://github.com/v8/v8/blob/7.5.283/include/v8.h#L2011-L2015) 的 HTML structured clone algorithm
